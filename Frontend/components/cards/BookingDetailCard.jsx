...
export const BookingDetailCard = () => {
  ...
  useEffect(() => {
    const fetchDetails = async () => {
      ...
      const bookingWithPopulate = await getBooking({
        token,
        query: `_id=${bookingId}&&populate=account_id`,
      });
      ...
      setName(
        bookingWithPopulate.bookings[0].account_id.first_name +
          " " +
          bookingWithPopulate.bookings[0].account_id.last_name
      );
  ...
  return (
    <div className="px-2 relative top-20 lg:w-[40%] lg:h-screen hdcard_white overflow-hidden">
      <div className="p-6" style={{ fontSize: "14px" }}>
        ...
        {console.log(booking?.receiptUrl)}
        <img
          alt="receipt"
          style={{ borderRadius: "10px", marginTop: "10px" }}
          className="border border-gray-300 card_bg2 "
          width={150}
          height={200}
          src={booking?.receiptUrl || '/images/receipt.jpg'}
        />

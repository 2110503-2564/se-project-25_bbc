  ...
  return (
    <div style={{position:"relative", overflow:"hidden", height:"450px"}} className="rounded-lg card_bg2 p-6 mb-4 bg-white text-gray-600">
      ...
      <div  className="grid grid-cols-[120px_1fr] gap-y-2 text-sm text-gray-600">
        ...
        <div className="ml-[150px] bg-white rounded-[5px] pl-[10px] pt-[5px]">{hotel?.name}</div>

        <div className="font-semibold m-[1px] bg-white rounded-[5px] p-[5px] text-blue-500">
          Room
        </div>
        <div className="ml-[150px] bg-white rounded-[5px] pl-[10px] pt-[5px]">{room?.room_number}</div>

        <div className="font-semibold m-[1px] bg-white rounded-[5px] p-[5px] text-blue-500">
          People
        </div>
        <div className="ml-[150px] bg-white rounded-[5px] pl-[10px] pt-[5px]">{booking.num_people}</div>
